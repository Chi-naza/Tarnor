...
class ChartFilterList extends StatelessWidget {
  final VoidCallback onTap;
  final String filterText;
  final bool isSelected;

  const ChartFilterList({Key? key, required this.onTap, required this.filterText, this.isSelected =  false}) : super(key: key);
